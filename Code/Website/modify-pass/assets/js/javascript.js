document.addEventListener("DOMContentLoaded", ()=>{
    ...
    a[0].addEventListener("click",()=>{
        if(check[0] == 1)
        {
            a[0].innerHTML = '<i class="far fa-eye-slash"></i>';
            document.getElementById("input-oldpassword").setAttribute("type","text");
            check[0] = !check[0];
        }
        else
        {
            a[0].innerHTML = '<i class="far fa-eye"></i>';
            document.getElementById("input-oldpassword").setAttribute("type","password");
            check[0] = !check[0];   
        }
    ...
    a[1].addEventListener("click",()=>{
        if(check[1] == 1)
        {
            a[1].innerHTML = '<i class="far fa-eye-slash"></i>';
    ...
    a[2].addEventListener("click",()=>{
        if(check[2] == 1)
        {
            a[2].innerHTML = '<i class="far fa-eye-slash"></i>';
